		...
		<section class="form-outer">
			<?php echo $this->Form->create("User", array("novalidate"=>true)); ?>
				<div class="form-section">
					...
					<p class="top-txt"><?php echo __("Don’t have an account?");?> <a href="<?php echo SITE_LINK."ready_to_signin"; ?>" title="<?php echo __("Sign Up Now");?>"><?php echo __("Sign Up Now");?></a>,<?php echo __("It takes less than a minute");?> </p>
					...
					<div class="row">
						...
						<div class="col-sm-6 text-right">
							<a href="forgot_password" title="<?php echo __("Forgot Password?");?>"><?php echo __("Forgot Password?");?></a>				
						</div>
					</div>
				</div>
